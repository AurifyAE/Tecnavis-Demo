...
async function fetchData() {
    socket.on('market-data', (data) => {
        ...
        silverBuy = (value2 + silverBidSpread).toFixed(3);
        silverSell = (value2 + silverBidSpread + silverAskSpread + parseFloat(0.05)).toFixed(3);

        var silverUSDResult = (value2 / 31.1035).toFixed(4)
